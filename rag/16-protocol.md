...
Ladder: artefact > repeated project context > technical description > stable symbol > noise router > isolated word.
GARAS classes: OBSERVE SYNC EXECUTE MONEY VENDOR CREDENTIAL DESTROY NOISE.
Default denied. Observe-only allow. Execute always gated. Paper pack ≠ Dual-Allow.
